...
class CommonButton @JvmOverloads constructor(
    ...
    init {
        context.obtainStyledAttributes(attrs, R.styleable.CommonButton).apply {
            ...
            mCornerPosition = getInt(R.styleable.CommonButton_cb_cornerPosition, -1)
            mActiveEnable = getBoolean(R.styleable.CommonButton_cb_activeEnable, false)
            mDrawablePosition = getInt(R.styleable.CommonButton_cb_drawablePosition, -1)
            mStartColor = getColor(R.styleable.CommonButton_cb_startColor, 0xFFFFFFFF.toInt())
            mEndColor = getColor(R.styleable.CommonButton_cb_endColor, 0xFFFFFFFF.toInt())
            mOrientation = getColor(R.styleable.CommonButton_cb_orientation, 0)
            recycle()
        }
    }
